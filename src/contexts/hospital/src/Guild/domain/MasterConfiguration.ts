...
import { MemberConfiguration } from "../../Member/domain/MemberConfiguration";

export class MasterConfiguration extends BaseObject {
  public timezone: StringValueObject;
  public lang: StringValueObject;
  public theme: StringValueObject;

  constructor(data: Primitives<MasterConfiguration>) {
    super();
